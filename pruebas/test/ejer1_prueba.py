...
class Transporte:
    ...
    def __str__(self):
        return f'Tipo: {self.tipo}, cantidad maxima de pasajeros: {self.cant_max_pasajero}'
...
class Auto(Vehiculo, Transporte):
    ...
    def __str__(self):
        return f'Auto con {super().__str__()}, con {super().__str__()}, es un {self.marca} {self.modelo} {self.patente}'
